...
define('FP_GIT_UPDATER_VERSION', '1.7.5');
...
$fp_gitupdater_runtime_api = FP_GIT_UPDATER_PLUGIN_DIR . 'includes/Services/Diagnostics/api.php';
if (is_readable($fp_gitupdater_runtime_api)) {
    require_once $fp_gitupdater_runtime_api;
}
